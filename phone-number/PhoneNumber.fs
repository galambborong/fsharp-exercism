...
let clean input =
    ...
    | n, _, _ when n.StartsWith('0') -> Error "area code cannot start with zero"
    | n, _, _ when n.Length = 11 && n.[1] = '0' -> Error "area code cannot start with zero"
    | n, _, _ when n.Length <> 11 && n.[0] = '1' -> Error "area code cannot start with one"
    | n, _, _ when n.Length = 11 && n.[1] = '1' -> Error "area code cannot start with one"
    | n, _, _ when n.Length = 10 && n.[3] = '0' -> Error "exchange code cannot start with zero"
    | n, _, _ when n.Length = 10 && n.[3] = '1' -> Error "exchange code cannot start with one"
    | n, _, _ when n.Length = 11 && n.[4] = '0' -> Error "exchange code cannot start with zero"
    | n, _, _ when n.Length = 11 && n.[4] = '1' -> Error "exchange code cannot start with one"
